...
/**
 * An Interpreter object evaluates the Abstract Syntax Trees (ASTs)
 * of Scheme expressions and definitions.
 */
public class Interpreter {
	 ...
	 * 
	 * @param ast the Abstract Syntax Tree (AST) of a expression or definition.
	...
	/**
	 * Evaluate the AST of a Scheme expression or definition in
	 * the given Environment.
	 * 
	 * @param ast the AST of a Scheme expression or definition
	 * @param env an Environment binding variables to their Values
	 * @return the Value which is the result of evaluating the AST
	 * @throws InterpreterException if an error occurs
	 */
