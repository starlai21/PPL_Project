...
/**
 * The BuiltinFunctions class defines all of the "built-in" primitive
 * functions (e.g., +, -, *, /, cons, car, cdr, etc.)
 */
public class BuiltinFunctions {
	/**
	 * Variant of PrimitiveFunction for functions with the type int x int -> int.
	 */
	...
	/**
	 * Variant of PrimitiveFunction for functions with the type int x int -> boolean.
	 */
	...
	/**
	 * Variant of PrimitiveFunction for functions with the type
	 * Cons -> ANY.
	 */
	...
	private static PrimitiveFunction[] allBuiltins = {
		...
		new IntegerComparisonFunction("=") {
			@Override
			public Boolean evaluate(Integer a, Integer b) { return a == b; }
		},
		new IntegerComparisonFunction("<") {
			@Override
			public Boolean evaluate(Integer a, Integer b) { return a < b; }
		...
		new NonemptyListFunction("car") {
			@Override
			public Value evaluate(Cons list) { return list.getCar(); }
		},
		new NonemptyListFunction("cdr") {
			@Override
			public Value evaluate(Cons list) { return list.getCdr(); }
		},
